			...
			<div className="page_container">
				<div className="container-fluid">
					<div className="row">
						{[1, 1].map((prev, i) => {
							return (
								<div key={i} className="col-12 col-sm-6 col-md-12 px-4 mt-3">
									<div className="row align-items-center shadowM">
										...
										<div className="col-12 col-md-7 py-3 py-md-0">
											...
											<p className="color1 f12 small lh-base">
												Walt Disney World’s 50th Anniversary begins October 1,
												and we are so excited to host “The World’s Most Magical
												Celebration!” Visit the 50th Anniversary HUBsite to view
												all the latest info as it’s released.
											</p>
